...
class QuestionMethodTests(TestCase):
	...
	def test_was_published_recently_with_old_question(self):
		"""
		was_published_recently() should return False for questions whose 		pub date is older than a day
		"""
		time = timezone.now() - datetime.timedelta(days=30)
	...
	def test_was_published_recently_with_recently_question(self):
		"""
		was_published_recently() should return true for questions whose 		pub date is within the last day
		"""
